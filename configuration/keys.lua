...
awful.keyboard.append_global_keybindings({
	...
	--awful.key({ modkey }, "Print", function()
      --awful.util.span_with_shell("scrot --focused --exec 'mv $f ~/Pictures/Screenshots/'")
  --end),

	-- awful.key({ }, "Print", function () awful.util.spawn("scrot") end),
	
	awful.key({ }, "Print", function () awful.util.spawn("scrot --exec 'mv $f ~/Pictures/Screenshots/'") end),
